...
internal sealed class MapConditionInvocationParser
{
    public PredicateInvocation Parse(MapEventConditionDefinition condition)
    {
        ...
        return condition.Type switch
        {
            ...
            "not_have_item" => CreateItemInvocation("not_have_item", condition.Value),
            ...
            "has_time_key" => CreateInvocation("has_time_key", ExprValue.FromString(condition.Value)),
            "not_has_time_key" => CreateInvocation("not_has_time_key", ExprValue.FromString(condition.Value)),
