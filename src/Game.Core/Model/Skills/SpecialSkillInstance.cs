    ...
    bool active) : SkillInstance(owner)
{
    ...
    public override bool CanCastAtSelf =>
        Definition.Targeting?.CanCastAtSelf ?? SkillTargetingDefaults.CanCastAtSelf(ImpactType);
    public override bool CanImpactSelf =>
        Definition.Targeting?.CanImpactSelf ?? SkillTargetingDefaults.CanImpactSelf;
